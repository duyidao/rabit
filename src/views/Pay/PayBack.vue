...
import { getPayDetailAPI } from "@api/pay";

const route = useRoute();
const payInfo = ref({});

const getPayFn = async () => {
  const res = await getPayDetailAPI(route.query.orderId);
    ...
    <div class="container">
      ...
      <div class="pay-result">
        ...
        <div class="btn">
          ...
          <el-button @click="$router.replace({path: '/'})">进入首页</el-button>
        </div>
        <p class="alert">
