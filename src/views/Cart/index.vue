...
// 点击修改选中状态
const handleCheckFn = (e, i) => {
  updateCheck(e, i);
};

// 全选变量
const allChecked = computed(() => cartList.value.length && cartList.value.every(item => item.selected))
...
<template>
  <div class="xtx-cart-page">
    <div class="container m-top-20">
      <div class="cart">
        <table>
          <thead>
            <tr>
              <th width="120">
                <el-checkbox :model-value="allChecked" @change="handleAllCheckFn" />
              </th>
      ...
      <div class="action">
        <div class="batch">
          共 {{ cartList.length }} 件商品，已选择 {{ cartChoseCount }} 件，商品合计：
